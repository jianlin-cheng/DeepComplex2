...
for filepath in fileNames:
    ...
    with open(run_file, "w") as f:
        ...
        cmd = "sh /storage/hpc/data/esdft/run_dock_gd.sh " + target_id + " " + initial_start + " " + restraint_file + " " + work_dir + " " + weight_file
        f.write("printf \"" + cmd + "\"\n")
        f.write(
            "sh /storage/hpc/data/esdft/run_dock_gd.sh " + target_id + " " + initial_start + " " + restraint_file + " " + work_dir + " " + weight_file + "\n")
