...
#################### Copy the already prepared alignments to the outdir/aligments/ folde. Later add the alignment generation code ######################33
if not os.path.isdir(outdir+"alignments/"): os.makedirs(outdir+"alignments/")
shutil.copy2("/storage/htc/bdm/farhan/string_db/hetero30_aln_run/hetero30_aln_joined_two/"+name_AB+".a3m",outdir+"alignments/")
shutil.copy2("/storage/htc/bdm/farhan/string_db/hetero30_aln_run/hetero30_aln_joined_two/"+name_AB+".aln",outdir+"alignments/")
