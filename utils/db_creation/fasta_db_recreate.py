...
def binding_only_file_reader(_seq_file):
    ...
    with open(_seq_file) as infile:
        ...
        data_counter_2220 = 0
        data_counter_1110 = 0
        file_object = open('/exports/store1/raj/future_task_new_db/new_strings_db', 'a')
        for line in infile:
            # print(line)
            ...
            name_AB = ">" + fasta_name_a + "__" + fasta_name_b
            fasta_order_a = binding_fasta_a+binding_fasta_b
            name_BA = ">" + fasta_name_b + "__" + fasta_name_a
            fasta_order_b = binding_fasta_b + binding_fasta_a
            file_object.write(name_AB.strip()+"\n")
            file_object.write(fasta_order_a.strip()+"\n")
            file_object.write(name_BA.strip()+"\n")
            file_object.write(fasta_order_b.strip()+"\n")
...
binding_only_file_reader('/exports/store1/raj/future_task_new_db/new_binding_file.txt')
