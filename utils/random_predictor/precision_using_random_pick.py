...
def calculateEvaluationStats(_true_cmap, _len_a, _len_b):
    L = _len_a + _len_b
...
for i in range(0, TIMES):
    ...
    for file in test_file_name:
        ...
        if os.path.isfile(predict_cmap):
            ...
            relax_0.append(calculateEvaluationStats(real_arr, len_a, len_b))

            real_arr_1 = make_relax(real_arr, 1)
            relax_1.append(calculateEvaluationStats(real_arr_1, len_a, len_b))
