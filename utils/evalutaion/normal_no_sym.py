...
predict_cmap_dir = "/home/rajroy/dncon_inter_predicted_contact_14_weigth/"
real_cmap_dir = "/home/rajroy/dncon_2_inter_true/"
for file in test_file_name:

    # name = file.split('_')
    predict_cmap =predict_cmap_dir+file[0:4]+".npy.txt"
...
if report == 0:
    ...
    FILE_NAME = "dncon_41_homo_std_8000_W_14"
...
# predict_cmap_dir = "/home/rajroy/dncon_inter_predicted_contact_14_weigth/"
# real_cmap_dir = "/home/rajroy/dncon_2_inter_true/"
predict_cmap_dir=real_cmap_dir ="/media/rajroy/fbc3794d-a380-4e0f-a00a-4db5aad57e75/hdd/DIMER_PAPER/cmap_drcon/"
for file in test_file_name:
    ...
    predict_cmap =predict_cmap_dir+file[0:4]+".npy.txt"
    # real_cmap = real_cmap_dir+file
    real_cmap = real_cmap_dir+"Y-"+file[0:4]+".txt"
